...
3. [&quot;Mugo&quot;: {&quot;Age&quot;: 23, &quot;Job&quot;: &quot;Software Engineer&quot;}, &quot;Kuto&quot;: {&quot;Age&quot;: 61, &quot;Job&quot;: &quot;Artist&quot;}]
4. **[{&quot;Age&quot;: 23, &quot;Job&quot;: &quot;Software Engineer&quot;}, {&quot;Age&quot;: 61, &quot;Job&quot;: &quot;Artist&quot;}]**
...
1. Formatting an array into a readable format
2. Removing all invalid entries from the array
3. Removing all values that do not meet the specified rule from the array
4. **Creating a new array with values from the original array that meet a specified rule**

**Feedback on correct answer:** Formatting an array into a readable format is usually done by the tool that is presenting this array to the developer. Also, this function does not remove anything from the original array.
...
1. Converting array to JSON
2. Showing all the variables and functions in the code
3. Modifying each element in an array by applying a specified function to it
4. **Creating a new array with values from the original array that were modified by applying a specified function to each one of them**

**Feedback on correct answer:** Converting array to JSON is done using other methods. There is no function to show all the variables and functions in the code. Like the filter() function, it goes through the elements of the array but rather than modifying the original, it returns a new modified array.
...
2. Remove all of the unused lines in the code
3. Reduce the memory usage of the app
4. **Returns a single value that is the result of a specified function applied to every element in the array**

**Feedback on correct answer:** Arithmetic operations are performed in JavaScript using mathematical symbols. Removing unused lines of code and reducing the memory usage are done by code optimization, not by a function executed with the rest of the code.

**Question 9**

**Question:** What function is used to start a server in the Express framework?

**Answers:**

1. var http = require (&#39;http&#39;); http.createServer (callback).listen (port\_number);
2. **var express = require (&#39;express&#39;); var app = express (); app.listen (port\_number);**
3. var express = require (&#39;express&#39;); express.createServer (callback).listen (port\_number);
4. var express = require (&#39;express&#39;); express.createServer (port\_number);

**Feedback on correct answer:**&quot;var http = require (&#39;http&#39;); http.createServer (callback).listen (port\_number);&quot; is a valid expression and is the method for staring the server in pure Node.js. You can see &quot;var express = require (&#39;express&#39;); var app = express (); app.listen (port\_number);&quot; being used in the code of this course&#39;s exercise. Refer to the Node.js and Express documentation for more information.

**Question 10**

**Question:** Query statements are passed to the Cloudant database from the application to operate data.

**Answers:** True | **False**

**Feedback on correct answer:** Cloudant DB does not have a query language associated with it.

**Question 11**

**Question:** What skills have you gained in this course (select all that apply)?
...
**Question:** What are the three types of expressions in the JavaScript language?

**Answers:**

1. Numbers, Text, Special Characters
2. **Numerical, String, Logical**
3. Boolean, Alphabets, Logical
4. Stings, Logic, Digits

**Question 13**

**Question:** Cloudant is an SQL database.

**Answers:** True | **False**

**Question 14**

**Question:** An example of associative array is **array[0]=&quot;Bill Hamm&quot;**

**Answers:** True | **False**

**Question 15**

**Question:** Which function returns the number of milliseconds between now and a fixed point in time (midnight January 1st 1970 GMT)?
...
**Question:** Which one is the right syntax for a trinary operator?
...
**Question:** What is the value returned by **Math.floor(5.23544)**?
...
**Question:** What happens if we enclose something in the \&lt;details\&gt;\&lt;/details\&gt; tags?

1. It gives more details about that topic
2. It becomes a link which the user can click to go to a search engine for getting more details
3. **It becomes an interactive widget that users can open and close to see details**
4. It changes the background color for that topic to give it more emphasis

**Question 19**

**Question:** Which variable did we use to store the Cloudant credentials in app.js?
...
**Question:** Every user in the visitor log application is supposed to have a history attribute.

**Answers:** True | **False**

# Assessment

## Quiz: Create the Back-end for a Visitor Logging App
...
**Feedback on correct answer:** Note that the list/array has numbers as keys and they cannot be assigned textual values like &quot;Mugo&quot; or &quot;Kuto&quot;.
...
You are now be able to write simple Node.js web applications on the IBM Cloud and store the data in Cloudant database. The main problem with this web application is that it is not visually appealing. Every change requires the entire page to be refreshed, and it is in plain HTML. The next course builds on this by creating a much more pleasing UI.

## Next Steps

_We hope you enjoyed this course._

_If you would like to continue learning about Web Development, you can view the following resources that IBM has to offer:_

- _Take the Create the front-end of a visitor logging tracking app course_
- [_Click here_](https://developer.ibm.com/africa/manage-learning-journey-development/?path=Web_Application_Developer)_to access the Web Application Developer track and add courses to your Learning Journey_
- _Look at various projects on_ [_IBM Developer_](https://developer.ibm.com/patterns/category/javascript,node-js,web-development/) _to create more web applications_
- _You can view additional resources at the_ [_IBM Coder Program_](https://ibmcoders.influitive.com/)
- _You can apply to the_ [_IBM Global EntrepreneurStartup with IBM_](http://developer.ibm.com/startups) _program_
